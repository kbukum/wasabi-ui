...
class Objects {
        ...
        switch (typeof object) {
            ...
            case "object":
                ...
                if (toString.call(object) !== "[object Array]") {
                    ...
                    for (let i = 0; i < (<Array<any>>object).length; i += 1) {
    ...
    public static clone(obj: any): Object {
        if (obj === null || typeof obj !== "object" || "isActiveClone" in obj || Assertions.isReactComponent(obj, false)) {
            return obj;
        }
        let temp;
        if (obj instanceof Date) {
            temp = (<any>obj.constructor()); // or new Date(obj);
        } else {
